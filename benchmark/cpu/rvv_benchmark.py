...
# Tuning core pipeline to reflect SiFive P550 + RVV Vector Unit
...
core.numPhysVecRegs = 64  # Physical Vector Register file for RVV
...
print("Starting RVV baseline simulation...")
simulator.run()
print("RVV baseline simulation finished successfully.")