...
int main() {
    ...
    // =========================================================
    // REGION 1: FARTHEST POINT SAMPLING
    // =========================================================
    printf("PROFILE_REGION_01_FPS_RVV\n");
    m5_reset_stats(0, 0);

    farthestPointSampling_rvv(
        b, n, m,
        dataset,
        temp,
        fps_idx
    ...
    // =========================================================
    // REGION 2: CENTROID GATHER
    // =========================================================
    printf("PROFILE_REGION_02_GATHER_RVV\n");
    m5_reset_stats(0, 0);
    ...
    // REGION 3: BALL QUERY
    // =========================================================
    printf("PROFILE_REGION_03_BALL_QUERY_RVV\n");
    m5_reset_stats(0, 0);

    query_ball_point_rvv(
        b, n, m,
        radius,
        nsample,
        dataset,
    ...
    // REGION 4: GROUPING
    // =========================================================
    printf("PROFILE_REGION_04_GROUPING_RVV\n");
    m5_reset_stats(0, 0);
    ...
    // =========================================================
    // REGION 5: SET-ABSTRACTION MLP + BN + RELU
    // =========================================================
    printf("PROFILE_REGION_05_SA_MLP_BN_RELU_RVV\n");
    m5_reset_stats(0, 0);
    ...
    // =========================================================
    // REGION 6: MAX POOLING
    // =========================================================
    printf("PROFILE_REGION_06_MAXPOOL_RVV\n");
    m5_reset_stats(0, 0);
    ...
    // =========================================================
    // REGION 7: 3-NEAREST NEIGHBORS
    // =========================================================
    printf("PROFILE_REGION_07_3NN_RVV\n");
    m5_reset_stats(0, 0);
    ...
    // =========================================================
    // REGION 8: INTERPOLATION WEIGHTS
    // =========================================================
    printf("PROFILE_REGION_08_WEIGHTS_RVV\n");
    m5_reset_stats(0, 0);
    ...
    // =========================================================
    // REGION 9: INTERPOLATION
    // =========================================================
    printf("PROFILE_REGION_09_INTERPOLATION_RVV\n");
    m5_reset_stats(0, 0);
