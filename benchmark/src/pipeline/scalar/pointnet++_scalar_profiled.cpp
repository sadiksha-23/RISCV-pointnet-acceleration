...
int main() {
    ...
    // =========================================================
    printf("PROFILE_REGION_02_GATHER\n");
    m5_reset_stats(0, 0);
    ...
    // REGION 3: BALL QUERY
    // =========================================================
    printf("PROFILE_REGION_03_BALL_QUERY\n");
    m5_reset_stats(0, 0);
    ...
    // REGION 4: GROUPING
    // =========================================================
    printf("PROFILE_REGION_04_GROUPING\n");
    m5_reset_stats(0, 0);
    ...
    // =========================================================
    printf("PROFILE_REGION_05_SA_MLP_BN_RELU\n");
    m5_reset_stats(0, 0);

    conv2d_mlp_bn_relu_cpu(
        b,
        m,
        nsample,
        c_in,
    ...
    // =========================================================
    printf("PROFILE_REGION_06_MAXPOOL\n");
    m5_reset_stats(0, 0);
    ...
    // =========================================================
    printf("PROFILE_REGION_08_WEIGHTS\n");
    m5_reset_stats(0, 0);
    ...
    // =========================================================
    printf("PROFILE_REGION_09_INTERPOLATION\n");
    m5_reset_stats(0, 0);
    ...
    // =========================================================
    printf("PROFILE_REGION_10_FINAL_MLP_BN_RELU\n");
    m5_reset_stats(0, 0);
